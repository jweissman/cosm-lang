...
test("example corpus exposes a stable catalog and notebook-facing wrapper", () => {
  ...
  expect(cosmEval('require "examples/spec/index"; Examples::Spec.ai_catalog().length')).toBe(4);
  expect(cosmEval('require "examples/spec/index"; Examples::Spec.ai_catalog().first().id')).toBe("ai_intent_router");
  ...
  expect(cosmEval('require "lib/app/examples"; App::Examples.ai_intent_router().path')).toBe("examples/spec/ai/intent_router.cosm");
  expect(cosmEval('require "lib/app/examples"; App::Examples.ai_support_triage().path')).toBe("examples/spec/ai/support_triage.cosm");
