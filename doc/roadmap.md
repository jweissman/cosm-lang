...
### Language / Runtime Track (`0.3.12.3`)
...
- split AI config discovery from actual backend health probing
...
### Platform / Proving-App Track (`0.3.12.3`)

- keep Slack DM ingress as a thin adapter around the same shared support core
- add one tiny page-backed conversation wedge in the server app
